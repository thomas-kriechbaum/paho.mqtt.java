...
public class MqttConnectOptions {
	...
	// Thomas Kriechbam -- taken form mqtt client
	/**
	...
	private void validateWill(String dest, Object payload) {
		...
		// Thomas Kriechbaum -- MqttAsyncClient.validateTopic ist not supported
		// asuming wildcards are allowed
		// MqttAsyncClient.validateTopic(dest);
		MqttTopic.validate(dest, true);
		// Thomas Kriechbaum
	}
	...
	// Thomas Kriechbaum --- Properties instead of Hashtable
